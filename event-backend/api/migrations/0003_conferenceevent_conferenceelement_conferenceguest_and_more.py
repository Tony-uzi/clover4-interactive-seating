    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "room_width",
                    models.DecimalField(decimal_places=2, default=24.0, max_digits=10),
                ),
                (
                    "room_height",
                    models.DecimalField(decimal_places=2, default=16.0, max_digits=10),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("booth_type", models.CharField(max_length=50)),
        ...
        migrations.AddIndex(
            model_name="conferenceevent",
            index=models.Index(
                fields=["organization_id"], name="api_confere_organiz_c89acd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="conferenceevent",
            index=models.Index(
                fields=["share_token"], name="api_confere_share_t_f90e97_idx"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="conferenceseatassignment",
            index=models.Index(
                fields=["element"], name="api_confere_element_79df3c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="conferenceseatassignment",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("event", "guest"), name="unique_guest_per_event"
            ),
        ),
        migrations.AddConstraint(
            model_name="conferenceseatassignment",
            constraint=models.UniqueConstraint(
                fields=("event", "element", "seat_number"),
                name="unique_seat_per_element_event",
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="tradeshowevent",
            index=models.Index(
                fields=["organization_id"], name="api_tradesh_organiz_439c7e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="tradeshowevent",
            index=models.Index(
                fields=["share_token"], name="api_tradesh_share_t_5e50b6_idx"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="tradeshowbooth",
            index=models.Index(
                fields=["category"], name="api_tradesh_categor_74760b_idx"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="tradeshowvendor",
            index=models.Index(
                fields=["company_name"], name="api_tradesh_company_1484d5_idx"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="tradeshowboothassignment",
            index=models.Index(
                fields=["vendor"], name="api_tradesh_vendor__5b8e68_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="tradeshowboothassignment",
            constraint=models.UniqueConstraint(
                fields=("event", "booth"), name="unique_vendor_per_booth_event"
            ),
        ),
        migrations.AddConstraint(
            model_name="tradeshowboothassignment",
            constraint=models.UniqueConstraint(
                fields=("event", "vendor"), name="unique_booth_per_vendor_event"
            ),
        ),
    ]
